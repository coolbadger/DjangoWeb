...
from admin import helpers, widgets
from admin.checks import (
    BaseModelAdminChecks, InlineModelAdminChecks, ModelAdminChecks,
)
from admin.exceptions import DisallowedModelAdminToField
from admin.templatetags.admin_urls import add_preserved_filters
...
class BaseModelAdmin(six.with_metaclass(forms.MediaDefiningClass)):
    ...
    def lookup_allowed(self, lookup, value):
        from admin.filters import SimpleListFilter
